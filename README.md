# InfiniteCopy Version 1.2.0 (Stable Release) ♾️
...
# Latest Update Patch 🆕
1. **You can now filter between text and images**
2. **You can now export all stored extension data into a JSON file**
# Known Bugs 🐞
--No current bugs--
